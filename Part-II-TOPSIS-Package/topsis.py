...
def main():
    """Main function to run TOPSIS from command line"""
    ...
    if len(sys.argv) != 5:
        error("Incorrect number of parameters.\n"
              "Usage: python -m topsis_palak_rollnumber <InputDataFile> <Weights> <Impacts> <OutputFileName>")
    ...
    try:
        ...
        error(f"Error reading the input file: {str(e)}")
